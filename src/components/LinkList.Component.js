                ...
                <div className="container-fluid">
                    ...
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className={`dropdown-menu bg-${theme}`} aria-labelledby="navbarDropdownMenuLink">
                                <li className='text-center my-1'><Link to={`/token`} className={`btn text-${themeText} btn-outline-success w-100`}>Crypto</Link></li>
                                <li className='text-center my-1'><Link to={`/fiis`} className={`btn text-${themeText} btn-outline-success w-100`}>Fundo Imobiliário</Link></li>
                            </ul>
                        </li>
