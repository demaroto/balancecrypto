            ...
            <main className={[theme, "container", "h-100", `bg-${theme}`].join(" ")}>
                <div className='row'>
                    <div className={`bg-${theme} p-5 rounded-lg m-3`}>
                        ...
                        <p className={`lead text-${themeText}`}>Não solicitamos nenhum dado pessoal, nem fazemos recomendações de investimentos. Todos geradores, calculadoras e outras ferramentas sempre serão gratuito neste portal.</p>
                        <hr className="my-4" />
